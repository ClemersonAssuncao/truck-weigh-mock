package com.duoweight.duoweigh.model;
...
public class WeightSimulator {
    ...
    public WeightSimulator(String scaleId, BigDecimal targetWeight) {
    ...
    private BigDecimal generateInitialWeight() {
        ...
        return targetWeight.multiply(BigDecimal.valueOf(factor))
